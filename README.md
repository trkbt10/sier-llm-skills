...
```bash
npm install screenshot-evidence-for-llm
```
...
import { createHeadlessCaptureStrategy } from "screenshot-evidence-for-llm";
...
import {
  ...
  historyToEvidence,
  buildEvidenceXlsx,
} from "screenshot-evidence-for-llm";
...
```json
{
  "mcpServers": {
    "evidence": {
      "command": "npx",
      "args": ["screenshot-evidence-for-llm"],
      "env": {
...
```typescript
import { historyToEvidence, buildEvidenceXlsx } from "screenshot-evidence-for-llm";
...
```typescript
import type { EvidenceSheetSchema } from "screenshot-evidence-for-llm";
