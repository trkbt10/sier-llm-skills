...
export function buildEvidenceStyleSheet(): XlsxStyleSheet {
  return {
    ...
    fonts: [
      ...
      { name: "Calibri", size: 11, bold: true, color: { type: "rgb", value: "FFFFFFFF" } },
      { name: "Calibri", size: 11, bold: true, color: { type: "rgb", value: "FF008000" } },
      { name: "Calibri", size: 11, bold: true, color: { type: "rgb", value: "FFFF0000" } },
    ],
    fills: [
      { type: "none" },
      { type: "pattern", pattern: { patternType: "gray125" } },
      { type: "pattern", pattern: { patternType: "solid", fgColor: { type: "rgb", value: "FF4472C4" } } },
      { type: "pattern", pattern: { patternType: "solid", fgColor: { type: "rgb", value: "FFF2F2F2" } } },
    ],
    borders: [
      {},
      {
        left: { style: "thin", color: { type: "rgb", value: "FFD0D0D0" } },
        right: { style: "thin", color: { type: "rgb", value: "FFD0D0D0" } },
        top: { style: "thin", color: { type: "rgb", value: "FFD0D0D0" } },
        bottom: { style: "thin", color: { type: "rgb", value: "FFD0D0D0" } },
      },
    ],
    cellXfs: [
      ...
      { numFmtId: numFmtId(0), fontId: fontId(0), fillId: fillId(0), borderId: borderId(1), applyBorder: true, alignment: { vertical: "top", wrapText: true }, applyAlignment: true },
      ...
      { numFmtId: numFmtId(0), fontId: fontId(0), fillId: fillId(3), borderId: borderId(1), applyFill: true, applyBorder: true, alignment: { vertical: "top", wrapText: true }, applyAlignment: true },
    ],
    cellStyleXfs: [
      { numFmtId: numFmtId(0), fontId: fontId(0), fillId: fillId(0), borderId: borderId(0) },
    ],
